...
?>
 ...
 <a href="" class="btn btn-success btn-rounded mb-4 " data-toggle="modal" data-target="#modalSubscriptionForm">Add Dog</a>
 </div>
<?php } ?>
 </div>
</div>
...
<textarea name="description" style="width:100%; height: 100px;" id="description" required></textarea>
 ...
 <div class="modal-footer d-flex justify-content-center">
 <button class="btn btn-indigo"id="updatedata" name="updatedata">Update <i class="fas fa-paper-plane-o ml-1" ></i></button>
 </div>
 </form>
 </div>
 </div> 
